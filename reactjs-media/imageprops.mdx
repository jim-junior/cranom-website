...
hide_title: false
custom_edit_url: https://github.com/jim-junior/blurifly-docs/tree/master/reactjs-media/imageprops.mdx
...
function ImageComponent() {
	return (
		<div>
			<Image src="/img/reactjs-media.png" loading="lazy" alt="LOGO" />
		</div>
	);
}
```
